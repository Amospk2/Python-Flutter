...
- Para Rodar o projeto na sua maquina primeiro garanta que todas as dependecias estão instaladas corretamente.

- Antes de iniciar a API configure o arquivo `config.py` com as informações do seu banco de dados MySQL.

- Para rodar a API, utilize `python3 run.py` no seu terminal.
...
```json
{
    "data": [
        {
            "created_on": "2022-06-20T01:49:12+00:00",
        ...
        {
            "created_on": "2022-06-20T02:09:35+00:00",
        ...
        {
            "created_on": "2022-06-20T14:49:06+00:00",
...
{
    "data": {
        "created_on": "2022-06-20T19:38:35+00:00",
...
{
    "data": {
        "created_on": "2022-06-20T01:38:55+00:00",
...
```json
{
 ...
 "exp": "Mon, 20 May 2022 10:45:50 GMT"
}
```
